							...
							<tr>
								...
								<td>
									...
									<fieldset class="safe-mode-plugin-options">
										...
										<label for="safe-mode-plugins_to_enable" class="bold"><?php esc_html_e('Plugins to Enable','wp-safe-mode'); ?></label>
									...
									<fieldset class="safe-mode-plugin-options">
										...
										<label for="safe-mode-plugins_to_keep" class="bold"><?php esc_html_e('Plugins to Keep Active','wp-safe-mode'); ?></label>
									...
									<fieldset class="safe-mode-plugin-options">
										...
										<label for="safe-mode-plugins_to_keep" class="bold"><?php esc_html_e('Disable Network Plugins','wp-safe-mode'); ?></label>
