	...
	?>
		...
		<div class="single_variation_wrap evotx_orderonline_add_cart" style="display:none;">
			...
			<div class="variations_button">				
				...
				<button data-product_id='<?php echo $woo_product_id;?>' id='cart_btn_v' type="submit" class="evoAddToCart evcal_btn button alt variable_add_to_cart_button"><?php echo eventon_get_custom_language($opt, 'evoTX_002','Add to Cart');?></button>
